...
public class ProductServiceImplServiceLocator extends org.apache.axis.client.Service implements com.mtit.Product.ProductServiceImplService {
    ...
    private java.lang.String ProductServiceImpl_address = "http://localhost:8080/Assignment2/services/ProductServiceImpl";
    ...
    public com.mtit.Product.ProductServiceImpl getProductServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.mtit.Product.ProductServiceImpl getProductServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mtit.Product.ProductServiceImplSoapBindingStub _stub = new com.mtit.Product.ProductServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mtit.Product.ProductServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mtit.Product.ProductServiceImplSoapBindingStub _stub = new com.mtit.Product.ProductServiceImplSoapBindingStub(new java.net.URL(ProductServiceImpl_address), this);
                _stub.setPortName(getProductServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Product.mtit.com", "ProductServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Product.mtit.com", "ProductServiceImpl"));
        }
